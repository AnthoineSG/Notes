...
⚠️ Cette operation a reliser de preference sur GitHub directement pour des raison de lisibiliter et d'historique plus claire
...
Elle met en surbrilance les differences dans le terminal, mais des options VSC permette les visualiser directement dans l'editeur de texte et GitHub permet de voir l'historique des commit directement sur le repo et donne acces a des options supplementaire
...
⚠️ ATTENTION COMMANDE TRES RISQUER ET IRREVERSIBLE
